          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end space-x-3">
            {userToken ? (
              <>
                ...
                <NavLink to={'wishList'} className="font-medium relative">
                  <i className="fa-2x fa-solid fa-heart text-red-500"></i>
                  <span className="text-white absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 ">
                    {wishList?.count}
                  </span>
                </NavLink>
                <span onClick={() => logOut()} className="cursor-pointer font-medium text-gray-900">
                  Log Out
                </span>
                <span className="px-3 rounded-lg text-white bg-main">{decoded?.name}</span>
              </>
